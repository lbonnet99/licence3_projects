...
<html>
    ...
    <body>
        ...
        <h1>Consultation billet le moins cher ayant pour destination Paris</h1>
...
$sql = "SELECT depart FROM Vol WHERE arrivee LIKE 'Paris' GROUP BY depart ORDER BY depart";
