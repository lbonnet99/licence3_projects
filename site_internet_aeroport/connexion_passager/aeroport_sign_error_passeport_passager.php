  ...
  <body>
    ...
    <div align="center">
      <table width="30%" class="tableau">
        <h1>INSCRIPTION</h1>
        <h3>Ce numéro de passeport a déjà été rentré.</h3>
        <form action="aeroport_insert_passager.php" method="post" id="sign">
          <tr>
          ...
          <tr>
            <td align="center">
                ...
                <br>
                <br>
              <input type="number" name="passeport" size="20" min="0" required>
            </td>
          </tr>
          <tr>
            <td align="center">
                ...
                <br>
                <br>
                <input type="number" name="identifiant" size="20" min="1" required>
            </td>
          </tr>
          <tr>
            <td align="center">
          ...
          <tr>
              <td align="center">
                <br>
                <br>
                <input type = "image" src="../images/button_submit.png" alt="Envoyer" width="35%">
              </td>
          </tr>
        </form>
    </table>
