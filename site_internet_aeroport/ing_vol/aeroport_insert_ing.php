...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    ?>
          <div align="center">
            <h3>Entrez un nouveau vol</h3>
            <form action="aeroport_insert_vols.php" method="post">
              <table width="30%" class = "tableau">
                ...
                <tr>
                  <td align="center">
                    ...
                    <br>
                    <br>
                    Oui : <input type="radio" name="escale" value="OUI" required>
                    Non : <input type="radio" name="escale" value="NON" required>
                    <br>
                    <br>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center">
                    ...
                    <br>
                    <br>
                    <input type="number" name="id_avion" min="1" required>
                    <br>
                    <br>
                  </td>
                </tr>
    ...
    ?>
          <div align="center">
            <h3>Entrez un nouvel avion</h3>
            <form class="" action="aeroport_insert_avion.php" method="post">
              <table width = "30%" class="tableau">
                <tr>
                  <td align="center">
                    Capacite :
    ...
    ?>
          <div align="center">
            <h3>Entrez une nouvelle compagnie</h3>
            <form action="aeroport_insert_compagnie.php" method="post">
              <table width = "30%" class="tableau">
                <tr>
                  <td align="center">
                    Nom de la compagnie :
                ...
                <tr>
                  <td align="center">
                    Nombre de vols à la semaine :
                    <br>
                    <br>
                    <input type="number" name="nb_vols_semaine" min="0" required>
                    <br>
                    <br>
                  </td>
                </tr>
