...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    $link->query("DELETE FROM Bagage WHERE num_billet IN (SELECT num_billet from Billet WHERE num_vol IN (SELECT num_vol FROM Vol WHERE id_avion IN (SELECT id_avion FROM Avion WHERE nom = '$nom')))") or die("Delete Error:" .$link->error());
    $link->query("DELETE FROM Billet WHERE num_vol IN (SELECT num_vol FROM Vol WHERE id_avion IN (SELECT id_avion FROM Avion WHERE nom = '$nom'))") or die("Delete Error:" .$link->error());
    $link->query("DELETE FROM Travaille WHERE num_vol IN (SELECT num_vol FROM Vol WHERE id_avion IN (SELECT id_avion FROM Avion WHERE nom = '$nom'))") or die("Delete Error:" .$link->error());
    $link->query("DELETE FROM Vol WHERE id_avion IN (SELECT id_avion FROM Avion WHERE nom = '$nom')") or die("Delete Error:" .$link->error());
    $link->query("DELETE FROM Avion WHERE nom = '$nom'") or die("Delete Error:" .$link->error());
    $link->query("DELETE FROM Compagnie WHERE nom = '$nom'") or die("Delete Error:" .$link->error());
